...
public class testSolucion {
    ...
    public void testAMenorQueB() {
        ...
        Camara camara1 = new Camara(1, 3, "1");
        Camara camara2 = new Camara(2, 5, "2");
        int n = 5;//5 muros
    ...
    public void testBMenorQueA() {
        ...
        Camara camara1 = new Camara(3, 2, "1");
        int n = 5;//5 muros
        ArrayList<Camara> camaras = new ArrayList<Camara>();
        camaras.add(camara1);
    ...
    public void testImpossible() {
        ...
        //falta el muro 3;
        Camara camara2 = new Camara(4, 5, "2");
        int n = 5;//5 muros
        ArrayList<Camara> camaras = new ArrayList<Camara>();
        camaras.add(camara1);
        camaras.add(camara2);
    ...
    public void testImpossible2() {
        ...
        Camara camara1 = new Camara(3, 1, "1");
        //falta el muro 2;
        int n = 5;//5 muros
        ArrayList<Camara> camaras = new ArrayList<Camara>();
        camaras.add(camara1);
